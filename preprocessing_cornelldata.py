...
def loadLines(fileName, fields):
    ...
    ) as f:  # TODO: Solve Iso encoding pb !
        for line in f:
            values = line.split(" +++$+++ ")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Extract conversations from Cornell movie dialog corpus"
    )
    ...
    conversations = loadConversations(
        os.path.join(args.input, "movie_conversations.txt"),
        lines,
        MOVIE_CONVERSATIONS_FIELDS,
    )
